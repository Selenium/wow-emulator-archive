...
//		return;
	...
	Packet.Port=8085;
	strcpy(Packet.IPAddr,"127.0.0.1");
	Packet.nPlayers=150;
	strcpy(Packet.Name,"nneonneo's WoW server");
	Addr myaddr;
	myaddr.IP=127<<24+1;
	myaddr.Port=9000;
	Server.AddRealm(&Packet,myaddr);

	memset(&Packet,0,sizeof(RealmPacket));
	Packet.Port=9000;
	strcpy(Packet.IPAddr,"127.0.0.1");
	Packet.nPlayers=150;
	strcpy(Packet.Name,"nneonneo's hacked up SC server");
	myaddr;
	myaddr.IP=127<<24+1;
	myaddr.Port=9000;
	Server.AddRealm(&Packet,myaddr);
