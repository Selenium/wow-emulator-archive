...
struct CreatureTemplateData
{
	...
	unsigned long Elite;
	unsigned long Flags;
	unsigned long DynamicFlags;
	unsigned long Type;
	unsigned long Faction;
	unsigned long Family;
	unsigned long NPCFlags;
	unsigned char Civilian;
	char QuestGiverText[128];
	unsigned long TemplateID;
	//unsigned int virtualItemDisplay[3];
	//struct CreatureItemInfo virtualItemInfo[3];
	unsigned long Mount;
	unsigned short MinRangeDmg;
	unsigned short MaxRangeDmg;
	unsigned short BaseAttackTime;
	unsigned short RangeAttackTime;
	unsigned short BoundingRadius;
	unsigned short CombatReach;
