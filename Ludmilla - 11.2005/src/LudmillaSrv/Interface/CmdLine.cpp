...
void CCmdLine::TranslateKeys(char *str)
{
	...
	AddToReport("LudmillaSrv.exe -i[:file[@host]]\n");
	AddToReport("LudmillaSrv.exe -b[@host]\n");
	AddToReport("LudmillaSrv.exe -e[@host]\n");
	AddToReport("LudmillaSrv.exe -r[@host]\n");
	AddToReport("\n");
	AddToReport("LudmillaSrv.exe -c:cmd[@host]\n");
	AddToReport("\n");
	AddToReport("LudmillaSrv.exe -li:[user[:pass]]@host\n");
	AddToReport("LudmillaSrv.exe -lo@host\n");
	AddToReport("\n");
	AddToReport("LudmillaSrv.exe -k\n");
	AddToReport("LudmillaSrv.exe -h\n");
	AddToReport("LudmillaSrv.exe -q\n");
}
//------------------------------------------------------------------------------
// -help или -h или -?
void CCmdLine::TranslateHelp(char *str)
{
	...
	AddToReport("	LudmillaSrv.exe -i[nstall][:file[@host]]\n");
	AddToReport("	LudmillaSrv.exe -b[egin][@host]\n");
	AddToReport("	LudmillaSrv.exe -e[nd][@host]\n");
	AddToReport("	LudmillaSrv.exe -r[emove][@host]\n");
	AddToReport("		Install/Run/Stop/Remove service\n");
	AddToReport("\n");
	AddToReport("Control of the service:\n");
	AddToReport("	LudmillaSrv.exe -c[ommand]:cmd[@host]\n");
	AddToReport("		Send cmd to Ludmilla's console on host\n");
	AddToReport("\n");
	AddToReport("Working with a network:\n");
	AddToReport("	LudmillaSrv.exe -login:[user[:pass]]@host or -li\n");
	AddToReport("		Add all needed resources (IPC$) for communication\n");
	AddToReport("	LudmillaSrv.exe -lo[gout]@host\n");
	AddToReport("		Remove connection to needed resources (IPC$)\n");
	AddToReport("\n");
	AddToReport("Additional functions:\n");
	AddToReport("	LudmillaSrv.exe -keys or -k\n");
	AddToReport("		Short keys list\n");
	AddToReport("	LudmillaSrv.exe -help or -h or -?\n");
	AddToReport("		This text\n");
	AddToReport("	LudmillaSrv.exe -q[uiet]\n");
