...
{
    Log::getSingleton( ).outDebug( "WORLD: Received CMSG_TAXINODE_STATUS_QUERY" );
...
{
    Log::getSingleton( ).outDebug( "WORLD: Received CMSG_TAXIQUERYAVAILABLENODES" );
...
{
    Log::getSingleton( ).outDebug( "WORLD: Received CMSG_ACTIVATETAXI" );
