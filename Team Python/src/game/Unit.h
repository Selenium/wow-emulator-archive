...
//    void AI_Escape(); // escape if health is low
    ...
    ///////  Flags /////////////////////////////////////////////////////////
    inline uint32 addUnitFlag(uint32 new_flag)
	{
    ...
    inline uint32 removeUnitFlag(uint32 old_flag)
	{
        uint32 flags = getUpdateValue(UNIT_FIELD_FLAGS);
        flags &= ~old_flag;
        setUpdateValue(UNIT_FIELD_FLAGS, flags);
	...
	inline void setkillerGUID(uint32 guid) { m_kguid = guid; };
	inline uint32 getkillerGUID() { return m_kguid; };
	uint32 m_kguid;
	...
	inline bool inCombat() { return m_combat; };
	inline void setCombat(bool f) { m_combat = f; };
	inline bool isWorldPort() { return m_wport; };
    inline void setWorldPort(bool f) { m_wport = f; }
	inline void setTaxiTime(uint32 traveltime) { m_taxi = traveltime; };
	inline void setTaxiNode(uint32 node) { m_taxinode = node; };
    ///////////////////////////////////////////////////////////////////////
