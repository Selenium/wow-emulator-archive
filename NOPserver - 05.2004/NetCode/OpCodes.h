...
/* Part of NOPServer by 0x90 */
/* Parsed from wowopcodes.html by daxxar with <3 vim <3 :) (wowopcodes.html by Foole) */
...
enum OpCodes {
    ...
    CMSG_PING = 0x01CE, /* Shifted by one after this. Erroneus? */
    SMSG_PONG = 0x01CF,
    SMSG_CLEAR_COOLDOWN = 0x01D0, 
    SMSG_GAMEOBJECT_PAGETEXT = 0x01D01,
    CMSG_SETWEAPONMODE = 0x01D2,
    SMSG_COOLDOWN_CHEAT = 0x01D3,
    SMSG_SPELL_DELAYED = 0x01D4,
    CMSG_PLAYER_MACRO = 0x01D5,
    SMSG_PLAYER_MACRO = 0x01D6,
    CMSG_GHOST = 0x01D7,
    CMSG_GM_INVIS = 0x01D8,
    CMSG_SCREENSHOT = 0x01D9,
    MSG_GM_BIND_OTHER = 0x01DA,
    MSG_GM_SUMMON = 0x01DB,
    SMSG_ITEM_TIME_UPDATE = 0x01DC,
    SMSG_ITEM_ENCHANT_TIME_UPDATE = 0x01DD,
    SMSG_AUTH_CHALLENGE = 0x01DE,
    CMSG_AUTH_SESSION = 0x01DF,
    SMSG_AUTH_RESPONSE = 0x01E0,
    MSG_GM_SHOWLABEL = 0x01E1,
    MSG_ADD_DYNAMIC_TARGET = 0x01E2,
    MSG_SAVE_GUILD_EMBLEM = 0x01E3,
    MSG_TABARDVENDOR_ACTIVATE = 0x01E4,
    SMSG_PLAY_SPELL_VISUAL = 0x01E5,
    CMSG_ZONEUPDATE = 0x01E6,
    SMSG_PARTYKILLLOG = 0x01E7,
    SMSG_COMPRESSED_UPDATE_OBJECT = 0x01E8,
    SMSG_MIRRORTIMERDAMAGELOG = 0x01E9,
    SMSG_EXPLORATION_EXPERIENCE = 0x01EA,
    CMSG_GM_SET_SECURITY_GROUP = 0x01EB,
    CMSG_GM_NUKE = 0x01EC,
    MSG_RANDOM_ROLL = 0x01ED,
    SMSG_ENVIRONMENTALDAMAGELOG = 0x01EE,
    CMSG_RWHOIS = 0x01EF,
    SMSG_RWHOIS = 0x01F0,
    //MSG_LOOKING_FOR_GROUP = 0x01F1, - Not this?
    CMSG_SET_LOOKING_FOR_GROUP = 0x01F2,
    SMSG_INITCLIENT = 0x01FB, /* SELFNAMED */
    ClientConnected = 0xFFFE, /* INTERNAL */
    KillClient = 0xFFFF, /* INTERNAL */
};
