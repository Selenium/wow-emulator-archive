/*
 *  As i leave i ask of a request inside of the server -  An antidebugger for release builds only..
 *  My antidebugger - i fixed it up from a botsource...im sure one of you know about botnets and how
 *  phatbot was made..but i think the creators of phatbot got it from another place...
 *
 *  Thats a private i havent given it out to one person so consider yourselfs lucky,
 *  dont use that while debugging with vs..because it will automatically close and call you stupid xD.
 *  Only use it on the FINAL compile of the server.. use #ifdef .... #endif
 *
 *  Dreamdok - [!Th3n3w].
 */

//!BEGIN ANTIDEBUGGER CPP
