...
enum OpCodes {
	...
	CMSG_SET_GUILD_INFORMATION = 0x02FA,
	SMSG_PET_TAME_UNK = 0x02FB,
	SMSG_UNKNOWN_PET = 0x02FC,
	CMSG_SET_WATCHED_FACTION_INDEX = 0x02FD,
	CMSG_SET_FACTION_INACTIVE = 0x02FE,
	CMSG_UNKNOWN_1 = 0x02FF,
	SMSG_UNKNOWN_DEMON = 0x0300,
	NUM_MSG_TYPES = 0x0301
#else
	MSG_NULL_ACTION = 0x0000,
	CMSG_BOOTME = 0x0001,
	CMSG_DBLOOKUP = 0x0002,
	...
	CMSG_CREATEITEM = 0x0013,
	CMSG_CREATEGAMEOBJECT = 0x0014,
	CMSG_MAKEMONSTERATTACKME = 0x0015, // CMSG_MAKEMONSTERATTACKME_OBSOLETE = 0x0015,
	CMSG_MAKEMONSTERATTACKGUID = 0x0016,
	CMSG_ENABLEDEBUGCOMBATLOGGING_OBSOLETE = 0x0017,
	CMSG_FORCEACTION = 0x0018,
	CMSG_FORCEACTIONONOTHER = 0x0019,
	...
	SMSG_AI_REACTION = 0x013C,
	CMSG_SET_SELECTION = 0x013D,
	CMSG_SET_TARGET = 0x013E, // CMSG_SET_TARGET_OBSOLETE = 0x013E,
	CMSG_UNUSED = 0x013F,
	CMSG_UNUSED2 = 0x0140,
	CMSG_ATTACKSWING = 0x0141,
	CMSG_ATTACKSTOP = 0x0142,
	...
	SMSG_PET_NAME_INVALID = 0x0178,
	SMSG_PET_SPELLS = 0x0179,
	CMSG_PET_CAST_SPELL_OBSOLETE = 0x017A, // SMSG_PET_MODE = 0x017A,
	CMSG_GOSSIP_HELLO = 0x017B,
	CMSG_GOSSIP_SELECT_OPTION = 0x017C,
	SMSG_GOSSIP_MESSAGE = 0x017D,
	SMSG_GOSSIP_COMPLETE = 0x017E,
	...
	CMSG_GHOST = 0x01E5,
	CMSG_GM_INVIS = 0x01E6,
	CMSG_SCREENSHOT = 0x01E7, // SMSG_INVALID_PROMOTION_CODE = 0x01E7,
	MSG_GM_BIND_OTHER = 0x01E8,
	MSG_GM_SUMMON = 0x01E9,
	SMSG_ITEM_TIME_UPDATE = 0x01EA,
	SMSG_ITEM_ENCHANT_TIME_UPDATE = 0x01EB,
	...
	SMSG_AUTH_RESPONSE = 0x01EE,
	MSG_GM_SHOWLABEL = 0x01EF,
	MSG_ADD_DYNAMIC_TARGET = 0x01F0, // MSG_ADD_DYNAMIC_TARGET_OBSOLETE = 0x01F0,
	MSG_SAVE_GUILD_EMBLEM = 0x01F1,
	MSG_TABARDVENDOR_ACTIVATE = 0x01F2,
	SMSG_PLAY_SPELL_VISUAL = 0x01F3,
	CMSG_ZONEUPDATE = 0x01F4,
	...
	CMSG_ENABLE_DAMAGE_LOG = 0x027D,
	CMSG_GROUP_CHANGE_SUB_GROUP = 0x027E,
	SMSG_RAID_MEMBER_STATS = 0x027F, // CMSG_REQUEST_PARTY_MEMBER_STATS = 0x027F,
	CMSG_GROUP_SWAP_SUB_GROUP = 0x0280,
	CMSG_RESET_FACTION_CHEAT = 0x0281,
	CMSG_AUTOSTORE_BANK_ITEM = 0x0282,
	CMSG_AUTOBANK_ITEM = 0x0283,
	...
	CMSG_TOGGLE_HELM = 0x02B9,
	CMSG_TOGGLE_CLOAK = 0x02BA,
	SMSG_SPELL_REFLECTED = 0x02BB, // SMSG_MEETINGSTONE_JOINFAILED = 0x02BB,
	SMSG_PLAYER_SKINNED = 0x02BC,
	SMSG_DURABILITY_DAMAGE_DEATH = 0x02BD,
	CMSG_SET_EXPLORATION = 0x02BE,
	CMSG_SET_ACTIONBAR_TOGGLES = 0x02BF,
	...
	*/
	NUM_MSG_TYPES = 0x02F2
#endif
};
#define MSG_HANDLERS NUM_MSG_TYPES
