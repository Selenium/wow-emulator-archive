...
BOOL CTownHallDlg::OnInitDialog()
{
	...
	// m_hIcon = AfxGetApp()->LoadIcon(IDR_MAINFRAME);
	m_TrayIcon.Create(NULL,WM_APP+10,_T("SWemu Realm Server"),m_hIcon,IDR_MENU,FALSE,0,0,0,10);
	Txt_ServerName.SetWindowText("SWemu Server");
	rs_started=FALSE;
