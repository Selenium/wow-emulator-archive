...
CRegionManager::CRegionManager(void)
{
	...
	*/
	...
	Continents[530]=new CContinent(530,10670.00f,-5867.00f,10670.00f,-5867.00f); // temp coords until real ones come :P
}
...
CRegionManager::~CRegionManager(void)
{
	/*	delete Continents[0];
	delete Continents[1];*/
	for(map<unsigned long,CContinent *>::iterator i=Continents.begin();i!=Continents.end();i++) delete i->second;
	Continents.clear();
}
