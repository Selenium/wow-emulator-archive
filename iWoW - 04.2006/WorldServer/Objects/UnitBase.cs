...
namespace WoWDaemon.World
{
	...
	public class UnitBase : LivingObject
	{
		...
		public override int MaxHealth
		{
			...
			set {m_maxHealth = value;UpdateValue(UNITFIELDS.MAXHEALTH);}
		}

		public override int Power
		{
			get {return m_power;}
			set {m_power = value;UpdateValue(((int)UNITFIELDS.POWER1) + (int)m_powerType);}
		}

		public override int MaxPower
		{
			get {return m_maxPower;}
			set {m_maxPower = value;UpdateValue(((int)UNITFIELDS.MAXPOWER1) + (int)m_powerType);}
		}
		...
		public override int Faction
		{
			...
			set {m_faction = value;UpdateValue(UNITFIELDS.FACTIONTEMPLATE);}
		}
