...
unsigned char count_bits_in_byte(unsigned char val);
...
enum Opcodes {
    ...
    SMSG_HARDWARE_SURVEY_REQUEST        = 742,  //(0x02E6)
    CMSG_HARDWARE_SURVEY_RESULTS        = 743,  //(0x02E7)
    SMSG_WARDEN_DATA                    = 744,  //(0x02E8)
    CMSG_WARDEN_DATA                    = 745,  //(0x02E9)
    SMSG_GROUP_JOINED_BATTLEGROUND      = 746,  //(0x02EA)
    MSG_BATTLEGROUND_PLAYER_POSITIONS   = 747,  //(0x02EB)
    CMSG_PET_STOP_ATTACK                = 748,  //(0x02EC)
    SMSG_BINDER_CONFIRM                 = 749,  //(0x02ED)
    SMSG_BATTLEGROUND_PLAYER_JOINED     = 750,  //(0x02EE)
    SMSG_BATTLEGROUND_PLAYER_LEFT       = 751,  //(0x02EF)
    CMSG_BATTLEMASTER_JOIN              = 752,  //(0x02F0)
    SMSG_ADDON_INFO                     = 753,  //(0x02F1)
    CMSG_PET_UNLEARN                    = 754,  //(0x02F2)
    SMSG_PET_UNLEARN_CONFIRM            = 755,  //(0x02F3)
    SMSG_PARTY_MEMBER_STATS_FULL        = 756,  //(0x02F4)
    CMSG_PET_SPELL_AUTOCAST             = 757,  //(0x02F5)
    SMSG_WEATHER                        = 758,  //(0x02F6)
    SMSG_PLAY_TIME_WARNING              = 759,  //(0x02F7)
    SMSG_MINIGAME_SETUP                 = 760,  //(0x02F8)
    SMSG_MINIGAME_STATE                 = 761,  //(0x02F9)
    CMSG_MINIGAME_MOVE                  = 762,  //(0x02FA)
    SMSG_MINIGAME_MOVE_FAILED           = 763,  //(0x02FB)
	CMSG_CANCEL_TEMPORARY_ENCHANTMENT	= 889,  //(0x0379)
	SMSG_MOVE_SET_FLY_SPEED				= 897,  //(0x0381)
	CMSG_MOVE_SET_FLY_SPEED_ACK			= 898,  //(0x0382)
...
inline const char* LookupName(unsigned int id, NameTableEntry *table)
{
    // OPTIMIZE ME!
