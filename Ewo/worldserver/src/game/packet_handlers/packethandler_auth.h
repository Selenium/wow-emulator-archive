...
#ifndef PACKETHANDLER_AUTH_H
#define PACKETHANDLER_AUTH_H
...
enum LoginErrorCode
{
    ...
    LOGIN_ERROR_CHAR_CREATE_FAILED                      = 0x30,
...
void send_proficiency (GameClient *pClient,uint8 b1=0, uint8 b2=0, uint8 b3=0, uint8 b4=0, uint8 b5=0);
