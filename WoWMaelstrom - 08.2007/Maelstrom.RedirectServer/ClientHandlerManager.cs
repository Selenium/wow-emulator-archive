...
namespace Maelstrom
{
	...
	/// </summary>
	public sealed class ClientHandlerManager
	{
		...
		/// <summary>
		/// Selects an available Client Handler Server based on the load of that server.
		/// </summary>
		public static ClientHandlerServerInfo PickServer()
		{
			return new ClientHandlerServerInfo(IPAddress.Loopback,0);
		}
