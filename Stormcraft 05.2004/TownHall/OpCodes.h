//channel 0=say 1=party   (second part is language)
//FEEDBACK bug: 0, suggestion: 1, note: 2
// attack on takes 64-bit guid
// attack off takes no data
...
enum OpCodes {
    ...
    SMSG_CANCEL_COMBAT = 0x0141,// possibly ok
    ...
    SMSG_DEATH_NOTIFY = 0x014C,//possibly ok
    ...
    SMSG_MOUNTSPECIAL_ANIM = 0x0165,//ok
    SMSG_PET_TAME_FAILURE = 0x0166,//ok
  ...
  /*  SMSG_PET_SPELLS = 0x016C,// <-
    ...
    SMSG_BUY_ITEM = 0x0174,//0x173
    SMSG_BUY_FAILED = 0x0175,
    CMSG_NPC_HELLO = 0x0176,*/
    SMSG_NPC_HYPERTEXT = 0x0176,
    CMSG_NPC_TEXT_QUERY = 0x0177,
    SMSG_NPC_TEXT_UPDATE = 0x0178,
    CMSG_NPC_OFFER_ITEM = 0x0179,
    SMSG_NPC_ACCEPT_ITEM = 0x017A,
    SMSG_NPC_DECLINE_ITEM = 0x017B,
    SMSG_NPC_WONT_TALK = 0x017C,
    CMSG_QUESTGIVER_STATUS_QUERY = 0x017D,
    SMSG_QUESTGIVER_STATUS = 0x017E,
    CMSG_QUESTGIVER_HELLO = 0x017F,
    SMSG_QUESTGIVER_QUEST_LIST = 0x0180,
    CMSG_QUESTGIVER_QUERY_QUEST = 0x0181,
    CMSG_QUESTGIVER_QUEST_AUTOLAUNCH = 0x0182,
    SMSG_QUESTGIVER_QUEST_DETAILS = 0x0183,
    CMSG_QUESTGIVER_ACCEPT_QUEST = 0x0184,
    CMSG_QUESTGIVER_COMPLETE_QUEST = 0x0185,
    SMSG_QUESTGIVER_REQUEST_ITEMS = 0x0186,
    CMSG_QUESTGIVER_REQUEST_REWARD = 0x0187,
    SMSG_QUESTGIVER_OFFER_REWARD = 0x0188,
    CMSG_QUESTGIVER_CHOOSE_REWARD = 0x0189,
    SMSG_QUESTGIVER_QUEST_INVALID = 0x018A,
    CMSG_QUESTGIVER_CANCEL = 0x018B,
    SMSG_QUESTGIVER_QUEST_COMPLETE = 0x018C,
    SMSG_QUESTGIVER_QUEST_FAILED = 0x018D,
    CMSG_QUESTLOG_SWAP_QUEST = 0x018E,
    CMSG_QUESTLOG_REMOVE_QUEST = 0x018F,
    SMSG_QUESTLOG_FULL = 0x0190,
    SMSG_QUESTUPDATE_FAILED = 0x0191,
    SMSG_QUESTUPDATE_COMPLETE = 0x0192,
    SMSG_QUESTUPDATE_ADD_KILL = 0x0193,
    SMSG_QUESTUPDATE_ADD_ITEM = 0x0194,
    CMSG_QUEST_CONFIRM_ACCEPT = 0x0195,
    SMSG_QUEST_CONFIRM_ACCEPT = 0x0196,
    CMSG_TAXICLEARALLNODES = 0x0197,
    CMSG_TAXIENABLEALLNODES = 0x0198,
    CMSG_TAXISHOWNODES = 0x0199,
    SMSG_SHOWTAXINODES = 0x019A,
    CMSG_TAXINODE_STATUS_QUERY = 0x019B,
    SMSG_TAXINODE_STATUS = 0x019C,
    CMSG_TAXIQUERYAVAILABLENODES = 0x019D,
    CMSG_ACTIVATETAXI = 0x019E,
    SMSG_ACTIVATETAXIREPLY = 0x019F,
    SMSG_NEW_TAXI_PATH = 0x01A0,
    CMSG_TRAINER_LIST = 0x01A1,
    SMSG_TRAINER_LIST = 0x01A2,
    CMSG_TRAINER_BUY_SPELL = 0x01A3,
    SMSG_TRAINER_BUY_SUCCEEDED = 0x01A4,
    SMSG_TRAINER_BUY_FAILED = 0x01A5,
    CMSG_BINDER_ACTIVATE = 0x01A6,
    SMSG_PLAYERBINDERROR = 0x01A7,
    CMSG_BANKER_ACTIVATE = 0x01A8,
    SMSG_SHOW_BANK = 0x01A9,
    CMSG_BUY_BANK_SLOT = 0x01AA,
    SMSG_BUY_BANK_SLOT_RESULT = 0x01AB,
    CMSG_PETITION_SHOWLIST = 0x01AC,
    SMSG_PETITION_SHOWLIST = 0x01AD,
    CMSG_PETITION_BUY = 0x01AE,
    CMSG_PETITION_SHOW_SIGNATURES = 0x01AF,
    SMSG_PETITION_SHOW_SIGNATURES = 0x01B0,
    CMSG_PETITION_SIGN = 0x01B1,
    SMSG_PETITION_SIGN_RESULTS = 0x01B2,
	SMSG_PETITION_UNKNOWN = 0x01B3,
	...
	CMSG_BUG  = 0x01BB,
	SMSG_NOTIFICATION  = 0x01BC,//0x1BC
	CMSG_PLAYED_TIME  = 0x01BD,
	SMSG_PLAYED_TIME  = 0x01BE,//0x1BE
	...
	SMSG_AUTH_CHALLENGE  = 0x01DD,//0x1DD
	CMSG_AUTH_SESSION  = 0x01DE,//0x1DE
	SMSG_AUTH_RESPONSE  = 0x01DF,//0x1DF
