...
Sub Send_Client_LOGON_CHALLENGE(Index As Integer, user As Integer)
...
Sub Send_Client_LOGON_PROOF(ClientA As String, ClientM1 As String, Index As Integer, user As Integer)
