...
{
	/// <summary>
	/// Summary description for GroupInteligentAI.
	/// </summary>
	public class GroupInteligentAI : BaseAIType
	{
		public GroupInteligentAI( BaseCreature bc ) : base( AITypes.NonAgressiveAnimalAI, bc )
		{
