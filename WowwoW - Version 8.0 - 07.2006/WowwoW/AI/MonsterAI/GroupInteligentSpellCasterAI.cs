...
{
	/// <summary>
	/// Summary description for GroupInteligentSpellCasterAI.
	/// </summary>
	public class GroupInteligentSpellCasterAI : BaseAIType
	{
		public GroupInteligentSpellCasterAI( BaseCreature bc ) : base( AITypes.NonAgressiveAnimalAI, bc )
		{
