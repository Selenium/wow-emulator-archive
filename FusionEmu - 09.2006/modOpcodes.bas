Attribute VB_Name = "modOpcodes"
'Opcodes will be stored here
'Current Opcodes are for 1.8.x
Option Explicit
...
Global Const login_bad_pass = &H5
Global Const login_account_already_logged = &H6
Global Const login_prepaid_time_used_up = &H7
Global Const login_could_not_log_in_try_again_later = &H8
Global Const login_bad_client_version = &H9

Global Const CHAR_LIST_RETRIEVING = &H2A
Global Const CHAR_LIST_RETRIEVED = &H2B
Global Const CHAR_LIST_FAILED = &H2C
...
Global Const CHAR_CREATE_CREATING_CHARACTER = &H2D
Global Const CHAR_CREATE_OK = &H2E
Global Const CHAR_CREATE_ERROR = &H2F
Global Const CHAR_CREATE_FAILED = &H30
Global Const CHAR_CREATE_NAME_IN_USE = &H31
Global Const CHAR_CREATE_RACE_CLASS_DISABLED = &H32
Global Const CHAR_CREATE_BOTH_HORDE_ALIANCE = &H33
Global Const CHAR_CREATE_MAX_CHARACTERS_ON_THIS_REALM = &H34
Global Const CHAR_CREATE_MAX_CHARACTERS_ON_THIS_ACCOUNT = &H35
Global Const CHAR_CREATE_CREATION_DISABLED = &H36
Global Const CHAR_CREATE_ONLY_EXISTING_CHARACTERS = &H37
...
Global Const CMSG_BOOTME = 1
Global Const CMSG_BUG = &H1CA
Global Const CMSG_BUSY_TRADE = 280
...
Global Const CMSG_CANCEL_AURA = 310
...
Global Const CMSG_CHANNEL_UNMODERATOR = 160
...
Global Const CMSG_EMBLAZON_TABARD_OBSOLETE = 13
...
Global Const CMSG_GAMESPEED_SET = 70
Global Const CMSG_GAMETIME_SET = &H44
Global Const CMSG_GET_MAIL_LIST = 570
...
Global Const CMSG_GM_VISION = 550
...
Global Const CMSG_GOSSIP_SELECT_OPTION = 380
...
Global Const CMSG_GROUP_INVITE = 110
Global Const CMSG_GROUP_RAID_CONVERT = &H28E
Global Const CMSG_GROUP_SET_LEADER = 120
Global Const CMSG_GROUP_SWAP_SUB_GROUP = 640
...
Global Const CMSG_GUILD_DEMOTE = 140
Global Const CMSG_GUILD_DISBAND = &H8F
Global Const CMSG_GUILD_INFO = &H87
Global Const CMSG_GUILD_INVITE = 130
...
Global Const CMSG_LOOT_MONEY = 350
...
Global Const CMSG_MEETING_STONE_CHEAT = 660
Global Const CMSG_MEETING_STONE_INFO = &H296
Global Const CMSG_MEETING_STONE_JOIN = &H292
Global Const CMSG_MEETING_STONE_LEAVE = &H293
Global Const CMSG_MESSAGECHAT = &H95
Global Const CMSG_MOUNTSPECIAL_ANIM = &H171
Global Const CMSG_MOVE_HOVER_ACK = &HF6
Global Const CMSG_MOVE_KNOCK_BACK_ACK = 240
Global Const CMSG_MOVE_SET_RAW_POSITION = &HE1
Global Const CMSG_MOVE_TIME_SKIPPED = &H2CE
Global Const CMSG_NAME_QUERY = 80
...
Global Const CMSG_PAGE_TEXT_QUERY = 90
...
Global Const CMSG_PLAYED_TIME = 460
Global Const CMSG_PLAYER_AI_CHEAT = 620
...
Global Const CMSG_PVP_PORT_OBSOLETE = 50
Global Const CMSG_QUERY_OBJECT_POSITION = 4
Global Const CMSG_QUERY_OBJECT_ROTATION = 6
...
Global Const CMSG_QUESTGIVER_CANCEL = 400
...
Global Const CMSG_QUESTGIVER_QUERY_QUEST = 390
...
Global Const CMSG_RECHARGE = 15
Global Const CMSG_RECLAIM_CORPSE = &H1D2
Global Const CMSG_REPAIR_ITEM = 680
...
Global Const CMSG_SERVER_BROADCAST = 690
...
Global Const CMSG_SETDEATHBINDPOINT = 340
Global Const CMSG_SETSHEATHED = 480
Global Const CMSG_SHEATHE_OBSOLETE = &H152
Global Const CMSG_SKILL_BUY_RANK = &H220
Global Const CMSG_SKILL_BUY_STEP = &H21F
Global Const CMSG_SPIRIT_HEALER_ACTIVATE = 540
Global Const CMSG_SPLIT_ITEM = 270
...
Global Const CMSG_TELEPORT_TO_UNIT = 9
Global Const CMSG_TEXT_EMOTE = 260
...
Global Const CMSG_UNEMBLAZON_TABARD_OBSOLETE = 14
...
Global Const CMSG_WHOIS = 100
Global Const CMSG_WORLD_TELEPORT = 8
Global Const CMSG_WRAP_ITEM = &H1D3
Global Const CMSG_XP_CHEAT = &H221
Global Const CMSG_ZONE_MAP = 10
Global Const CMSG_ZONEUPDATE = 500
...
Global Const MSG_MOVE_SET_SWIM_SPEED_CHEAT = 210
...
Global Const MSG_MOVE_STOP_TURN = 190
...
Global Const MSG_MOVE_TOGGLE_FALL_LOGGING = 200
...
Global Const MSG_MOVE_WORLDPORT_ACK = 220
Global Const MSG_NULL_ACTION = 0
Global Const MSG_PETITION_DECLINE = 450
Global Const MSG_PETITION_RENAME = &H2C1
Global Const MSG_QUERY_NEXT_MAIL_TIME = &H284
Global Const MSG_QUEST_PUSH_RESULT = 630
...
Global Const SMSG_ACTIVATETAXIREPLY = 430
Global Const SMSG_AI_REACTION = &H13C
Global Const SMSG_AREA_TRIGGER_MESSAGE = &H2B8
Global Const SMSG_ATTACKERSTATEUPDATE = 330
...
Global Const SMSG_AUTH_RESPONSE2_UNKNOWN180 = &H2F1
...
Global Const SMSG_BUY_ITEM = 420
...
Global Const SMSG_CHAR_DELETE = 60
...
Global Const SMSG_DEBUGINFOSPELLMISS_OBSOLETE = 30
Global Const SMSG_DESTROY_OBJECT = 170
Global Const SMSG_DISMOUNTRESULT = &H16F
Global Const SMSG_DISPEL_FAILED = 610
Global Const SMSG_DUEL_COMPLETE = &H16A
Global Const SMSG_DUEL_COUNTDOWN = &H2B7
Global Const SMSG_DUEL_INBOUNDS = &H169
Global Const SMSG_DUEL_OUTOFBOUNDS = 360
...
Global Const SMSG_FORCE_SWIM_SPEED_CHANGE = 230
...
Global Const SMSG_INITIALIZE_FACTIONS = 290
...
Global Const SMSG_ITEM_TEXT_QUERY_RESPONSE = 580
Global Const SMSG_ITEM_TIME_UPDATE = 490
...
Global Const SMSG_LOOT_ALL_PASSED = 670
...
Global Const SMSG_MEETING_STONE_COMPLETE = &H297
Global Const SMSG_MEETING_STONE_IN_PROGRESS = &H298
Global Const SMSG_MEETING_STONE_INFO = &H295
Global Const SMSG_MEETING_STONE_MEMBER_ADDED = &H299
Global Const SMSG_MESSAGECHAT = 150
Global Const SMSG_MONSTER_MOVE = &HDD
Global Const SMSG_MONSTER_MOVE_TRANSPORT = &H2AE
Global Const SMSG_MOUNTRESULT = &H16E
Global Const SMSG_MOUNTSPECIAL_ANIM = 370
...
Global Const SMSG_PERIODICAURALOG = 590
Global Const SMSG_PET_ACTION_FEEDBACK = 710
...
Global Const SMSG_PLAYER_SKINNED = 700
...
Global Const SMSG_QUERY_OBJECT_POSITION = 5
Global Const SMSG_QUERY_OBJECT_ROTATION = 7
...
Global Const SMSG_QUESTUPDATE_ADD_ITEM = 410
...
Global Const SMSG_SHOW_BANK = 440
...
Global Const SMSG_SPELL_REFLECTED = &H2BB
...
Global Const SMSG_STANDSTATE_CHANGE_ACK = &H29D
...
Global Const SMSG_SUPERCEDED_SPELL = 300
...
Global Const SMSG_TRIGGER_CINEMATIC = 250
...
Global Const INVTYPE_NONE = 0
Global Const INVTYPE_HEAD = 1
Global Const INVTYPE_NECK = 2
Global Const INVTYPE_SHOULDER = 3
Global Const INVTYPE_BODY = 4
Global Const INVTYPE_CHEST = 5
Global Const INVTYPE_WAIST = 6
Global Const INVTYPE_LEGS = 7
Global Const INVTYPE_FEET = 8
Global Const INVTYPE_WRIST = 9
Global Const INVTYPE_HAND = 10
Global Const INVTYPE_FINGER = 11
Global Const INVTYPE_TRINKET = 12
Global Const INVTYPE_WEAPON = 13
Global Const INVTYPE_SHIELD = 14
Global Const INVTYPE_RANGED = 15
Global Const INVTYPE_CLOAK = 16
Global Const INVTYPE_2HWEAPON = 17
Global Const INVTYPE_BAG = 18
Global Const INVTYPE_TABARD = 19
Global Const INVTYPE_ROBE = 20
Global Const INVTYPE_WEAPONMAINHAND = 21
Global Const INVTYPE_WEAPONOFFHAND = 22
Global Const INVTYPE_HOLDABLE = 23
Global Const INVTYPE_AMMO = 24
Global Const INVTYPE_THROWN = 25
Global Const INVTYPE_RANGEDRIGHT = 26
