...
namespace WoWDaemon.World
{
	...
	public class PlayerObject : LivingObject
	{
		...
		[UpdateValueAttribute(PLAYERFIELDS.MOD_DAMAGE_DONE_POS)]
...
*/
		...
		public override void PreCreateObject(bool isClient)
		{
			...
			if(isClient)
			{
				...
				UpdateValue(PLAYERFIELDS.SKILL_POINTS);
				UpdateValue(PLAYERFIELDS.TALENT_POINTS);
				UpdateValue(PLAYERFIELDS.STRENGTH);
				UpdateValue(PLAYERFIELDS.AGILITY);
				UpdateValue(PLAYERFIELDS.STAMINA);
				UpdateValue(PLAYERFIELDS.INTELLECT);
				UpdateValue(PLAYERFIELDS.SPIRIT);
		...
		[UpdateValueAttribute(UNITFIELDS.AURA00)]
		protected ulong m_aura00;
		public ulong Aura00
		{
			get {return m_aura00;}
			set { UpdateValue(UNITFIELDS.AURA00); m_aura00 = value;}
		}

		[UpdateValueAttribute(UNITFIELDS.AURAAPPLICATIONS0)]
		protected ulong m_auraApplications0;
		public ulong AuraApplications0
		{
			get {return m_auraApplications0;}
			set { UpdateValue(UNITFIELDS.AURAAPPLICATIONS0); m_auraApplications0 = value;}
		}

		[UpdateValueAttribute(UNITFIELDS.AURALEVELS0)]
		protected ulong m_auraLevels0;
		public ulong AuraLevels0
		{
			get {return m_auraLevels0;}
			set { UpdateValue(UNITFIELDS.AURALEVELS0); m_auraLevels0 = value;}
		}
		#endregion
		...
		public int NextLevelExp
		{
			...
			set { m_nextLevelExp = value;UpdateValue(PLAYERFIELDS.NEXTLEVEL_XP); }
		}
		...
		*/
		...
		[UpdateValueAttribute(PLAYERFIELDS.SKILL_POINTS)]
		public override int SkillPoints
		{
			get { return m_character.SkillPoints;}
			set { m_character.SkillPoints = value;UpdateValue(PLAYERFIELDS.SKILL_POINTS);}
		}

		[UpdateValueAttribute(PLAYERFIELDS.TALENT_POINTS)]
		public override int TalentPoints
		{
			get { return m_character.TalentPoints;}
			set { m_character.TalentPoints = value;UpdateValue(PLAYERFIELDS.TALENT_POINTS);}
		}

		[UpdateValueAttribute(PLAYERFIELDS.GUILD_ID)]
		public override uint GuildID
		{
			get { return m_character.GuildID;}
			set { m_character.GuildID = value;UpdateValue(PLAYERFIELDS.GUILD_ID);}
		}

		[UpdateValueAttribute(PLAYERFIELDS.GUILD_RANK)]
		public override uint GuildRank
		{
			get { return (uint)m_character.GuildRank;}
			set { m_character.GuildRank = (uint)value;UpdateValue(PLAYERFIELDS.GUILD_RANK); }
		}
		...
		public int ModDamageDone
		{
			...
			set { m_moddamagedone = value;UpdateValue(PLAYERFIELDS.MOD_DAMAGE_DONE_POS); }
		}
		...
		[UpdateValueAttribute(PLAYERFIELDS.STRENGTH)]
		...
		[UpdateValueAttribute(PLAYERFIELDS.AGILITY)]
		...
		[UpdateValueAttribute(PLAYERFIELDS.STAMINA)]
		...
		[UpdateValueAttribute(PLAYERFIELDS.INTELLECT)]
		...
		[UpdateValueAttribute(PLAYERFIELDS.SPIRIT)]
		...
		[UpdateValueAttribute(UNITFIELDS.RESIST_PHYSICAL)]
		public override int Resist_Physical
		{
			get {return m_character.Resist_Physical;}
			set {m_character.Resist_Physical = value;UpdateValue(UNITFIELDS.RESIST_PHYSICAL);}
		}

		[UpdateValueAttribute(UNITFIELDS.RESIST_HOLY)]
		public override int Resist_Holy
		{
			get {return m_character.Resist_Holy;}
			set {m_character.Resist_Holy = value;UpdateValue(UNITFIELDS.RESIST_HOLY);}
		}

		[UpdateValueAttribute(UNITFIELDS.RESIST_FIRE)]
		public override int Resist_Fire
		{
			get {return m_character.Resist_Fire;}
			set {m_character.Resist_Fire = value;UpdateValue(UNITFIELDS.RESIST_FIRE);}
		}

		[UpdateValueAttribute(UNITFIELDS.RESIST_NATURE)]
		public override int Resist_Nature
		{
			get {return m_character.Resist_Nature;}
			set {m_character.Resist_Nature = value;UpdateValue(UNITFIELDS.RESIST_NATURE);}
		}

		[UpdateValueAttribute(UNITFIELDS.RESIST_FROST)]
		public override int Resist_Frost
		{
			get {return m_character.Resist_Frost;}
			set {m_character.Resist_Frost = value;UpdateValue(UNITFIELDS.RESIST_FROST);}
		}

		[UpdateValueAttribute(UNITFIELDS.RESIST_SHADOW)]
		public override int Resist_Shadow
		{
			get {return m_character.Resist_Shadow;}
			set {m_character.Resist_Shadow = value;UpdateValue(UNITFIELDS.RESIST_SHADOW);}
		}
		...
		[UpdateValueAttribute(UNITFIELDS.ATTACKPOWERMODIFIER)]
		public override int AttackPowerModifier
		{
			get {return m_character.AttackPowerModifier;}
			set {m_character.AttackPowerModifier = value;UpdateValue(UNITFIELDS.ATTACKPOWERMODIFIER);}
		}
	
		[UpdateValueAttribute(PLAYERFIELDS.COINAGE)]
