	...
	public class PlayerConfig : System.Windows.Forms.Form
	{
		...
		private void searchPLAYERCONF_Click(object sender, System.EventArgs e)
		{
			...
			else
			{
				...
				this.bstrUSER.Update();
				this.strUSER.Text = c.Strength.ToString();
				this.strUSER.Update();
				this.intUSER.Text = c.Intellect.ToString();
				this.intUSER.Update();
				this.agilUSER.Text = c.Agility.ToString();
				this.agilUSER.Update();
				this.staUSER.Text = c.Stamina.ToString();
				this.staUSER.Update();
				this.spiUSER.Text = c.Spirit.ToString();
				this.spiUSER.Update();
		...
		private void savePLAYECONF_Click(object sender, System.EventArgs e)
		{
			...
			else
			{
				...
				client.Player.Strength = Convert.ToInt32(this.strUSER.Text);
				client.Player.Stamina = Convert.ToInt32(this.staUSER.Text);
				client.Player.Agility = Convert.ToInt32(this.agilUSER.Text);
				client.Player.Spirit = Convert.ToInt32(this.spiUSER.Text);
				client.Player.Intellect = Convert.ToInt32(this.intUSER.Text);
