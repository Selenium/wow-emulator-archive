...
void WorldSession::HandleItemQuerySingleOpcode( WorldPacket & recv_data )
{
    ...
    if( pProto )
    {
        ...
        data << uint32(0xffffffff);   //2.0.7

		data << pProto->Name1;
		data << uint8(0)<< uint8(0)<< uint8(0);    
        //data << pProto->Name2; //2.0.6
        //data << pProto->Name3; //2.0.6
        //data << pProto->Name4; //2.0.6
        ...
        for(int s = 0; s < 5; s++)
        {
            ...
            else
            {
                ...
                if(db_data)
                {
                    data<< uint32(0xffffffff);//data << uint32(pProto->Spells[s].SpellCooldown);
                    data << uint32(pProto->Spells[s].SpellCategory);
                    data<< uint32(0xffffffff);//data << uint32(pProto->Spells[s].SpellCategoryCooldown);
                }
                else
                {
        ...
        data << pProto->Sheath;
        data << pProto->Extra;
		data << pProto->RandProp;
        data << pProto->Block;
        data << pProto->ItemSet;
        data << pProto->MaxDurability;
        data << pProto->Area;
        data << pProto->Map;
        data << pProto->BagFamily;                           // Added in 1.12.x client branch
		data << pProto->TotemCat;
		for (int i = 0; i < 3; i++)
		{
			data << pProto->Socket[i].SocketColor;
			data << pProto->Socket[i].SocketContent;
		}
		data << pProto->SpellItemEnchantment;
		data << pProto->GemProperties;
		data << pProto->HonorCost;
		data << pProto->DisenchantSkillReq;
    
		/* Old unknown item types, fixed now ~ShiKage
		for(int i = 0; i < 10; i++) //2.0.6
        {
            data<< uint32(0);
        }
		data<< uint32(0);//2.0.6
		data<< uint32(0xffffffff);//2.0.6
		*/
