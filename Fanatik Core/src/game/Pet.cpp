...
bool Pet::LoadPetFromDB( Unit* owner, uint32 petentry )
{
    ...
    switch(getPetType())
    {
        ...
        case HUNTER_PET:
            ...
            //SetUInt32Value(UNIT_FIELD_FLAGS, UNIT_FLAG_UNKNOWN1 + UNIT_FLAG_RESTING);//2.0.8
			SetUInt32Value(UNIT_FIELD_FLAGS, 2088);//2.0.8 mmrpg4free
			...
			SetUInt32Value(UNIT_FIELD_BYTES_0,(33685760)); //2.0.8
            break;
        default:
...
bool Pet::CreateBaseAtCreature(Creature* creature)
{
    ...
    {
        //SetUInt32Value(UNIT_FIELD_BYTES_1,creature->GetUInt32Value(UNIT_FIELD_BYTES_1)); //2.0.8
