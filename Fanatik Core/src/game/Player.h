...
#define BUYBACK_SLOT_1               74
#define BUYBACK_SLOT_2               75
#define BUYBACK_SLOT_3               76
#define BUYBACK_SLOT_4               77
#define BUYBACK_SLOT_5               78
#define BUYBACK_SLOT_6               79
#define BUYBACK_SLOT_7               80
#define BUYBACK_SLOT_8               81
#define BUYBACK_SLOT_9               82
#define BUYBACK_SLOT_10              83
#define BUYBACK_SLOT_11              84
#define BUYBACK_SLOT_12              85
#define BUYBACK_SLOT_END             86

//#define KEYRING_SLOT_START           81
//#define KEYRING_SLOT_END             97
#define KEYRING_SLOT_START           86  //2.0.8
#define KEYRING_SLOT_END             102 //2.0.8


// last+1 slot for item stored (in any way in player m_items data)
//#define PLAYER_SLOT_END              97
#define PLAYER_SLOT_END              102  //2.0.8
...
#define TRADE_SLOT_COUNT             8 //2.0.6
...
enum MovementFlags
{
	...
	MOVEMENTFLAG_ONTRANSPORT    = 0x200, //2.0.7
