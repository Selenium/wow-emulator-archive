...
enum ITEM_TOTEMCAT
{
	ITEM_TOTEMCAT_SKINNING			= 1,
	ITEM_TOTEMCAT_EARTH				= 2,
	ITEM_TOTEMCATY_AIR				= 3,
	ITEM_TOTEMCAT_FIRE				= 4,
	ITEM_TOTEMCAT_WATER				= 5,
	ITEM_TOTEMCAT_COPPER_ROD		= 6,
	ITEM_TOTEMCAT_SILVER_ROD		= 7,
	ITEM_TOTEMCAT_GOLDEN_ROD		= 8,
	ITEM_TOTEMCAT_TRUESILVER_ROD	= 9,
	ITEM_TOTEMCAT_ARCANITE_ROD		= 10,
	ITEM_TOTEMCAT_MINING			= 11,
	ITEM_TOTEMCAT_PHILOSOPHER_STONE	= 12,
	ITEM_TOTEMCAT_SMITH				= 13,
	ITEM_TOTEMCAT_ARCLIGHT			= 14,
	ITEM_TOTEMCAT_GYROMATIC			= 15,
	ITEM_TOTEMCAT_MASTER_TOTEM		= 21,
	ITEM_TOTEMCAT_FEL_IRON_ROD		= 41,
	ITEM_TOTEMCAT_ADAMANTITE_ROD	= 62,
	ITEM_TOTEMCAT_ETERNIUM_ROD		= 63
};

enum ITEM_SOCKET_TYPE
{
	ITEM_SOCKET_META				= 1,
	ITEM_SOCKET_RED					= 2,
	ITEM_SOCKET_YELLOW				= 4,
	ITEM_SOCKET_BLUE				= 8
};
