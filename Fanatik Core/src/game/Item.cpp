...
void Item::SetItemRandomProperties(uint32 randomPropId)
{
    ...
    if(item_rand)
    {
        ...
        SetUInt32Value(ITEM_FIELD_ENCHANTMENT+4*3,item_rand->enchant_id_1); //2.0.6
        SetUInt32Value(ITEM_FIELD_ENCHANTMENT+4*4,item_rand->enchant_id_2); //2.0.6
        SetUInt32Value(ITEM_FIELD_ENCHANTMENT+4*5,item_rand->enchant_id_3); //2.0.6
    } 
}
