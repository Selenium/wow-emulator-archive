...
const char AreaTableEntryfmt[]="ixinixxxxxixxxxxxxxxixxxxxx"; //2.0.7
const char BankBagSlotPricesEntryfmt[]="ni";
const char ChrClassesEntryfmt[]="nxxixsxxxxxxxxxxxx"; //2.0.7
//const char ChrRacesEntryfmt[]="nxixxxxxixxxxxixisxxxxxxxxxxx";
const char ChrRacesEntryfmt[]="nxixxxxxixxxiisxxxxxxxxxxxx";
...
const char MapEntryfmt[]="nsixxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxx"; //2.0.7
...
const char SpellEntryfmt[]="niixiiiiixxiixiiixixxiiiiiiiiiiiiiiiiiiifiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiffffffiiixxxiiiiiiiiiiiiiiifffiiiiiiiiiiiifffixiiissssssssissssssssixxxxxxxxxxxxxxxxxxiiiiiixiixxfffxxxxxx";  //2.0.7
const char SpellFocusObjectfmt[]="nsxxxxxxxx";
const char SpellItemEnchantmentfmt[]="nixxixxixxixxsxxxxxxxxiixx"; //2.0.7
